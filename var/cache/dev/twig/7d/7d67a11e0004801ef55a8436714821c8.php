...
class __TwigTemplate_e74af829e6ac7163252c96b5a6b559ee extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"sf-tabs\">
        ...
        echo "
                ...
                ";
        // line 164
        if ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "content", [], "any", false, false, false, 164) == false)) {
            // line 165
            echo "                    <div class=\"empty\">
...
($context["collector"] ?? null), "content", [], "any", false, false, false, 168)) {
        ...
        echo "</span>
                    ...
                    <div class=\"metric\">
                        <span class=\"value\">";
        // line 268
        echo twig_source($this->env, (("@WebProfiler/Icon/" . ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "statelesscheck", [], "any", false, false, false, 268)) ? ("yes") : ("no"))) . ".svg"));
        echo "</span>
...
";
    ...
    {
        return new Source("", "@WebProfiler/Collector/request.html.twig", "/home/teo/projects/ec_app/vendor/symfony/web-profiler-bundle/Resources/views/Collector/request.html.twig");
    }
}
